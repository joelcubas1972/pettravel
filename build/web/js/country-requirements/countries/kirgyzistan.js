var KirgyzistanPetTravelForm = {
    countryCode: "KG",
    countryName: "Kirgyzistán",
    ...
    requirements: [
        ...
        },
        {
            ...
            description: "Certificado veterinario oficial USDA para exportación a Kirgyzistán (Forma № 15, edición 9 julio 2019)",
            required: true,
            type: "certificate",
            appliesto: ["all"]
        }
...
(function () {
    if (!window.KirgyzistanPetTravelForm) {
        window.KirgyzistanPetTravelForm = KirgyzistanPetTravelForm;
        window.KGPetTravelForm = KirgyzistanPetTravelForm;
    }
    // Añadir a petTravelDB si existe
    if (typeof window !== 'undefined' && window.petTravelDB) {
        window.petTravelDB.addCountry('KG', KirgyzistanPetTravelForm);
    }
})();